report 50103 "CarersVIC Purchase - Order"
{
    Caption = 'CarersVIC Purchase - Order';
    DefaultLayout = RDLC;
    RDLCLayout = './Report/CarersVICPurchaseOrder.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(DocumentDate; Format("Posting Date", 0, 4))
            {
            }
