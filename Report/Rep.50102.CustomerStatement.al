report 50102 "CarersVIC Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/CarersVICStatement.rdl';
    Caption = 'CarersVIC Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(PaymentTermsDesc; Customer."Payment Terms Code")
                {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(Debit_Amount; ABS("Debit Amount"))
                            {

                            }
                            column(Credit_Amount; ABS("Credit Amount"))
                            {
                            ...
                            begin
                                ...
                                SalesInvHeader.SetRange("No.", "Detailed Cust. Ledg. Entry"."Document No.");
                                If SalesInvHeader.FindFirst() then begin
                                    ReferenceNo := SalesInvHeader."Your Reference";
                                end;
