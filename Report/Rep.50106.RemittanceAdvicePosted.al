report 50106 "CarersVIC Remitt. Adv. Posted"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/Layout/CarersVICRemittanceAdvPosted.rdl';
    Caption = 'CarersVIC Remitt. Adv. Posted';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(VendLedgEntry2; "Vendor Ledger Entry")
            {
                ...
                column(Posting_Date; Format(VendLedgEntry2."Posting Date")) { }
                column(LAmountWDiscCur; -1 * LAmountWDiscCur)
                {
                }
