report 50100 "CarersVIC Sales - Invoice"
{
    Caption = 'CarersVIC Sales - Invoice';
    Permissions = TableData "Sales Shipment Buffer" = rimd;
    PreviewMode = PrintLayout;
    WordMergeDataItem = Header;
    DefaultLayout = RDLC;
    RDLCLayout = './Report/CarersVICPostedSalesInvoice.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(Balance_Amount; BalanceAmount)
            {
            ...
            column(CompanyInfoACNNo; CompanyInfo."IRD No.")
            {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(TotalSub_Total; TotalSubTotal)
                {

                }
                column(TotalAmount_VAT; TotalAmountVAT)
                {

                }
                column(TotalAmountIncl_VAT; TotalAmountInclVAT)
                {

                }
                column(Payment_Amount; PaymentAmount)
                {
            ...
            begin
                ...
                PaymentAmount := 0;
                BalanceAmount := 0;
                TotalAmountInclVATFromHeader := 0;
                ...
                if SalesInvLine.FindSet() then
                    repeat
                        TotalAmountInclVATFromHeader += SalesInvLine."Amount Including VAT";
                    Until SalesInvLine.Next() = 0;
                BalanceAmount := TotalAmountInclVATFromHeader - PaymentAmount;
    ...
    protected var
        ...
        TotalAmountInclVATFromHeader: Decimal;
